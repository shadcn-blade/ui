    ...
    <div class="max-w-6xl mx-auto space-y-16">
        ...
        <section class="space-y-6">
            <div>
                ...
                <p class="text-sm text-muted-foreground">Displays the path to the current resource using a hierarchy of links.</p>
            </div>
            ...
            <div class="space-y-2">
                ...
                <x-ui.breadcrumb>
                    <x-ui.breadcrumb-list>
                        ...
                        <x-ui.breadcrumb-item>
                            <x-ui.breadcrumb-link href="/components">Components</x-ui.breadcrumb-link>
                        </x-ui.breadcrumb-item>
                        <x-ui.breadcrumb-separator />
                        <x-ui.breadcrumb-item>
            ...
            {{-- With Dropdown --}}
            <div class="space-y-2">
                <p class="text-sm font-semibold">With Ellipsis</p>
                <x-ui.breadcrumb>
                    <x-ui.breadcrumb-list>
                        <x-ui.breadcrumb-item>
                            <x-ui.breadcrumb-link href="/">Home</x-ui.breadcrumb-link>
            ...
            {{-- Custom Separator --}}
            <div class="space-y-2">
                <p class="text-sm font-semibold">Custom Separator</p>
                <x-ui.breadcrumb>
                    <x-ui.breadcrumb-list>
                        <x-ui.breadcrumb-item>
                            <x-ui.breadcrumb-link href="/">Home</x-ui.breadcrumb-link>
        ...
        <section class="space-y-6">
            <div>
                <h2 class="text-2xl font-bold">Toggle</h2>
            ...
            {{-- Sizes --}}
            <div class="space-y-2">
                <p class="text-sm font-semibold">Sizes</p>
                <div class="flex items-center gap-2">
                    <x-ui.toggle size="sm" variant="outline">
                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                        </svg>
                    </x-ui.toggle>
                    ...
                    <x-ui.toggle size="lg" variant="outline">
                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                        </svg>
                    </x-ui.toggle>
            ...
            <div class="space-y-2">
                <p class="text-sm font-semibold">Disabled</p>
                <x-ui.toggle :disabled="true" variant="outline">
                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                    </svg>
                </x-ui.toggle>
